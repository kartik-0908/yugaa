...
export default function AssignedTo({ id, assigneeId, shopDomain, userId }: { id: string, shopDomain: string, assigneeId: string, userId: string }) {
    const [currassigneeId, setAssigneeId] = useState('')
    const handleChange = (value: string) => {
        console.log(`value: ${value}`)
        setAssigneeId(value)
        updateAssignee(id, value, userId, shopDomain)
    }
