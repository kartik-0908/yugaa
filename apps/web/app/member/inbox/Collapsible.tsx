...
const RightPanelToggle = ({ ticket, messages, emails }: any) => {
                ...
                return (
                    <div className=''>
                        ...
                        <div className=' flex flex-row w-full gap-2'>
                            <button
                                className='bg-red p-2 rounded-3xl'
    ...
    return (
        <div className="flex h-full w-full">
            <div className={`h-[600px] transition-all duration-1500 ease-in-out ${isRightPanelVisible ? 'w-1/2' : 'w-full'}`}>
            ...
            {isRightPanelVisible && (
                <div id="rightPanel" className={`h-[600px] bg-gray-100 transition-all duration-1500 ease-in-out ${isRightPanelVisible ? 'w-1/2' : 'w-0 overflow-hidden'}`}>
                    {isRightPanelVisible &&
